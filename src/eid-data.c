                            ...
                            if (retVal == CKR_OK)
                            {
                                ...
                                for (slotIdx = 0; slotIdx < slot_count; slotIdx++)
                                {
                                    ...
                                    if (retVal == CKR_OK)
                                    {
                                         ...
                                         */
                                        CK_CHAR_PTR pFilename = "carddata_glob_os_version";
                                        CK_CHAR_PTR pSignatureFilename = "CARD_DATA";
                                        CK_CHAR_PTR pLastname = "surname";
                                        /*
                                        ...
                                        if (pFileValue != NULL) free (pFileValue);
                                        if (pSignatureValue != NULL) free (pSignatureValue);
                                        if (pLastnameValue != NULL) free (pLastnameValue);
